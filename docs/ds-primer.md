...
Re-score only your high-tenure customers and their `tenure_months` re-spreads across the whole (0, 1] range, so the model sees a population it never trained on.

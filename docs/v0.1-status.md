...
| NFR-09 docs | mkdocs site (built strict in CI, published to GitHub Pages from main - enable Pages once: Settings -> Pages -> GitHub Actions), 27 ADRs, external-quality README, quickstart, troubleshooting runbook with reproduced failure modes |

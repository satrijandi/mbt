...
Pipeline: churn_demo_training_v1
Target: docker
"""
...
with DAG(
    dag_id="churn_demo_training_v1",
    default_args=default_args,
    schedule="@daily",
    start_date=datetime(2026, 1, 1),
    catchup=False,
    tags=["mbt", "churn_demo_training_v1"],
) as dag:
    ...
    feature_selection = DockerOperator(
    ...
    split_data >> feature_selection
    split_data >> drift_detection
    split_data >> train_model
    drift_detection >> train_model
    feature_selection >> train_model

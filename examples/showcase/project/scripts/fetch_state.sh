...
# pipelines can fall back to a full build.
#
# Ported unchanged from the mbt init scaffold (DESIGN.md section 6): the
# state branch is pure git plumbing and works against Gitea as-is.
#
